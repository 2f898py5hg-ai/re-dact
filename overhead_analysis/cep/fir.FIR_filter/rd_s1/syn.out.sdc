...
# Created by write_sdc on Sun Dec 21 14:01:54 2025
...
-to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_91_my_FIR_filter_firBlock_right_Y_reg_13__csb_out_mux]  \
-from I0 -to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_91_my_FIR_filter_firBlock_right_Y_reg_13__csb_in_mux]   \
-from I0 -to Z
...
-to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_15_my_FIR_filter_firBlock_right_Y_reg_7__csb_out_mux]   \
-from I0 -to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_15_my_FIR_filter_firBlock_right_Y_reg_7__csb_in_mux]    \
-from I0 -to Z
...
-to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_643_my_FIR_filter_firBlock_right_Y_reg_31__csb_out_mux] \
-from I0 -to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_643_my_FIR_filter_firBlock_right_Y_reg_31__csb_in_mux]  \
-from I1 -to Z
...
-to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_56_my_FIR_filter_firBlock_right_Y_reg_17__csb_out_mux]  \
-from I0 -to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_56_my_FIR_filter_firBlock_right_Y_reg_17__csb_in_mux]   \
-from I1 -to Z
...
-to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_4_my_FIR_filter_firBlock_right_Y_reg_3__csb_out_mux]    \
-from I0 -to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_4_my_FIR_filter_firBlock_right_Y_reg_3__csb_in_mux]     \
-from I0 -to Z
...
-to Z
set_disable_timing [get_cells modified_inst_csb_inst_34_csb_out_mux] -from I1  \
-to Z
set_disable_timing [get_cells modified_inst_csb_inst_34_csb_in_mux] -from I1   \
-to Z
...
-to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_38_my_FIR_filter_firBlock_right_Y_reg_18__csb_out_mux]  \
-from I0 -to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_38_my_FIR_filter_firBlock_right_Y_reg_18__csb_in_mux]   \
-from I0 -to Z
set_disable_timing [get_cells modified_inst_csb_inst_374_csb_out_mux] -from I1 \
-to Z
set_disable_timing [get_cells modified_inst_csb_inst_374_csb_in_mux] -from I1  \
-to Z
