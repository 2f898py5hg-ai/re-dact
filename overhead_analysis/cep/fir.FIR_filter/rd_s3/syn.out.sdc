...
# Created by write_sdc on Sun Dec 21 13:49:34 2025
...
modified_inst_csb_inst_73_my_FIR_filter_firBlock_right_Y_reg_27__csb_out_mux]  \
-from I0 -to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_73_my_FIR_filter_firBlock_right_Y_reg_27__csb_in_mux]   \
-from I1 -to Z
...
-to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_93_my_FIR_filter_firBlock_right_Y_reg_22__csb_out_mux]  \
-from I0 -to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_93_my_FIR_filter_firBlock_right_Y_reg_22__csb_in_mux]   \
-from I0 -to Z
...
-to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_54_my_FIR_filter_firBlock_right_Y_reg_23__csb_out_mux]  \
-from I0 -to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_54_my_FIR_filter_firBlock_right_Y_reg_23__csb_in_mux]   \
-from I0 -to Z
...
-to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_18_my_FIR_filter_firBlock_right_Y_reg_18__csb_out_mux]  \
-from I0 -to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_18_my_FIR_filter_firBlock_right_Y_reg_18__csb_in_mux]   \
-from I1 -to Z
...
-to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_742_my_FIR_filter_firBlock_right_Y_reg_31__csb_out_mux] \
-from I0 -to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_742_my_FIR_filter_firBlock_right_Y_reg_31__csb_in_mux]  \
-from I1 -to Z
...
-to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_22_my_FIR_filter_firBlock_right_Y_reg_24__csb_out_mux]  \
-from I0 -to Z
set_disable_timing [get_cells                                                  \
modified_inst_csb_inst_22_my_FIR_filter_firBlock_right_Y_reg_24__csb_in_mux]   \
-from I1 -to Z
